...
public final class EventListItemBinding implements ViewBinding {
  ...
  private EventListItemBinding(@NonNull ConstraintLayout rootView, @NonNull TextView eventDate,
  ...
  public static EventListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new EventListItemBinding((ConstraintLayout) rootView, eventDate, eventTitle);
    }
