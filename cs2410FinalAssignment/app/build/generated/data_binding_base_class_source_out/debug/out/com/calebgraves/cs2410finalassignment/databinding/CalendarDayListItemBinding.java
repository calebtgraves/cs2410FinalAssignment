...
public final class CalendarDayListItemBinding implements ViewBinding {
  @NonNull
  ...
  private CalendarDayListItemBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull ConstraintLayout event, @NonNull ConstraintLayout scrollConstraintLayout,
      @NonNull ConstraintLayout scrollParent, @NonNull ScrollView scrollView,
  ...
  @NonNull
  public static CalendarDayListItemBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static CalendarDayListItemBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.calendar_day_list_item, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static CalendarDayListItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.event;
      ConstraintLayout event = ViewBindings.findChildViewById(rootView, id);
      if (event == null) {
        break missingId;
      }
      ...
      return new CalendarDayListItemBinding((ConstraintLayout) rootView, constraintLayout10,
