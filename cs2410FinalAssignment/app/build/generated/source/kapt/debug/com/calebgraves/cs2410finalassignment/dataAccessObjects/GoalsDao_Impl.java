...
public final class GoalsDao_Impl implements GoalsDao {
  ...
  public GoalsDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfGoal = new EntityInsertionAdapter<Goal>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `goals` (`id`,`title`,`category`,`description`,`startDate`,`endDate`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfGoal = new EntityDeletionOrUpdateAdapter<Goal>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `goals` SET `id` = ?,`title` = ?,`category` = ?,`description` = ?,`startDate` = ?,`endDate` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Object createGoal(final Goal goal, final Continuation<? super Long> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Long>() {
      @Override
      public Long call() throws Exception {
        __db.beginTransaction();
        try {
          long _result = __insertionAdapterOfGoal.insertAndReturnId(goal);
  ...
  @Override
  public Object deleteGoal(final Goal goal, final Continuation<? super Unit> continuation) {
      ...
      public List<Goal> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Goal(_tmpId,_tmpTitle,_tmpCategory,_tmpDescription,_tmpStartDate,_tmpEndDate);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object goalById(final long id, final Continuation<? super Goal> continuation) {
      ...
      public Goal call() throws Exception {
        ...
        try {
          ...
          if(_cursor.moveToFirst()) {
            ...
            final long _tmpEndDate;
            _tmpEndDate = _cursor.getLong(_cursorIndexOfEndDate);
            _result = new Goal(_tmpId,_tmpTitle,_tmpCategory,_tmpDescription,_tmpStartDate,_tmpEndDate);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object goalsForDay(final long day, final Continuation<? super List<Goal>> continuation) {
    final String _sql = "SELECT * FROM goals WHERE startDate <= ? AND endDate >= ?";
